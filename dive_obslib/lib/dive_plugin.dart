...
class DivePlugin {
  ...
  static Future<Map> getSceneItemInfoMap(String sceneUUID, int itemId) {
    return _channel.invokeMethod(
        _methodGetSceneItemInfo, {'scene_uuid': sceneUUID, 'item_id': itemId});
  }

  static Future<bool> setSceneItemInfo(String sceneUUID, int itemId, Map info) {
    return _channel.invokeMethod(_methodSetSceneItemInfo,
        {'scene_uuid': sceneUUID, 'item_id': itemId, 'info': info});
  }
