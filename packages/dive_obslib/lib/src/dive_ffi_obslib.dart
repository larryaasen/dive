...
extension DiveFFIObslib on DiveBaseObslib {
  ...
  bool streamOutputCreate({
    ...
    final serviceObj = _lib!
        .obs_service_create(serviceId.int8(), "default_service".int8(), serviceSettings.pointer, ffi.nullptr);
  ...
  List<Map<String, String?>> inputsFromType(String inputTypeId) {
    ...
    ffi.Pointer<obs_property>? property = _lib!.obs_properties_first(sourceProps);
    while (property != null) {
